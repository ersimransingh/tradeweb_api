...
#box(
  ...
  [
     #grid(
      ...
      [
	  	#text(size: 8pt, weight: "bold", "Annexure A2 | Legal Entity / Other than Individuals")
	  ]
	)
	 #v(-10pt)
	#grid(
      ...
      [
              #grid(
                ...
                [
					...
					#linebreak()
					#text("I) For particular section update, please tick() in the box section number and strike off the sections not required to be updated."),
				]
           )          
      ],
...
////// For Identity column box
  #box(
    ...
    #grid(
      ...
      [
	  	#text(size: 8.5pt, weight: "bold", "1.  DETAILS OF RELATED PERSON(Please refer instruction E at the end)")
	  ]
	)
	#v(-2pt)
		    ...
		    #grid(
			  ...
			  stroke: none, // for adding border
				 grid[
					 ...
					 #text((if ReKycDetails.DetailRelPerson == "Updation" { " ☑" } else { " ☐" }) + " Update Related Person Details")
				 #linebreak()  #linebreak()	#text(" KYC Number of Related Person (If available*)  ") #text(ReKycDetails.KYCNumber) #h(40pt) #text("   If kyc number available,only related person Type & name is mandatory")
				 #linebreak()  #linebreak() #text(weight:"bold", "Related Person Type* ")
					 #text(if ReKycDetails.RelPersonType == "Director" { " ☑" } else { " ☐" } + " Director")
					 #text(if ReKycDetails.RelPersonType == "Promoter" { " ☑" } else { " ☐" } + " Promoter ")
					 #text(if ReKycDetails.RelPersonType == "Karta" { " ☑" } else { " ☐" } + " Karta ")
					 #text(if ReKycDetails.RelPersonType == "Trustee" { " ☑" } else { " ☐" } + " Trustee ")
					 #text(if ReKycDetails.RelPersonType == "Partner" { " ☑" } else { " ☐" } + " Partner ")
					 #text(if ReKycDetails.RelPersonType == "CortAppt" { " ☑" } else { " ☐" } + " Court Appointment Official ")
					 #text(if ReKycDetails.RelPersonType == "Proprietor" { " ☑" } else { " ☐" } + " Proprietor ")
				 #linebreak()  #linebreak()	#text("   ") #h(80pt) 
					 #text(if ReKycDetails.RelPersonType == "Benificiary" { " ☑" } else { " ☐" } + " Benificiary ")
					 #text(if ReKycDetails.RelPersonType == "Promoter" { " ☑" } else { " ☐" } + " Authorised Signatory ")
					 #text(if ReKycDetails.RelPersonType == "Karta" { " ☑" } else { " ☐" } + " Benificial Owner ")
					 #text(if ReKycDetails.RelPersonType == "Trustee" { " ☑" } else { " ☐" } + " Power of Attorney Holder ")
					 #text(if ReKycDetails.RelPersonType == "Partner" { " ☑" } else { " ☐" } + " Other (Please specify) ")
				 #linebreak()  #linebreak()	#text("DIN (Director Identification Number) ") #text(ReKycDetails.DIN) #h(30pt) #text("  (Mandatory if Related person type is  Director)")
    ...
    #grid(
	  ...
	  fill: rgb(185, 221, 235),
      [
	  	#text(size: 8.5pt, weight: "bold", "1.1  PERSONAL DETAILS(Please refer instruction E at the end)")
	  ]
	)
	 #grid(
      columns: (4fr, 8fr),
	  ...
	  grid[
		 ...
		 grid[
		   ...
		   #text((if ReKycDetails.Nationality == "IN" { "☑" } else { "☐" }) + " INDIAN ")
		   #text((if ReKycDetails.Nationality == "OT" { "☑" } else { "☐" }) + " Other  (ISO 3166 Country Code) ")
		   
           #text(ReKycDetails.PAN)  #text(" Form 60 furnished")  #v(0pt)
	...
	#grid(
		...
		fill: rgb(185, 221, 235),
         [
			#text(size: 8.5pt, weight: "bold", "1.2 PROOF OF IDENTITY AND ADDRESS* (Please refer instruction E at the end)")
		 ]
	)
	...
	#grid(
		  ...
		  fill: rgb(185, 221, 235),
		    [
			   #text(size: 8.5pt, weight: "bold", "1.3 CURRENT ADDRESS DETAILS * (Please refer instruction E at the end)")
			]
	)
	  ...
	  inset: 0pt,
		  [
			#grid(
				  ...
				  fill: rgb(185, 221, 235),
				  [
					#text(size: 8.5pt, weight: "bold"," 1.4 CONTACT DETAILS (All communication will be sent on provided mobile no./ Email-ID)(Please refer instruction D at the end)")
				  ]			
				)
			...
			//Applicaton Declaration
				...
				#grid(
				  ...
				  fill: rgb(185, 221, 235),
					  [
						#text(size: 8.5pt, weight: "bold"," 2. Application Declaration")
					  ]
				)
