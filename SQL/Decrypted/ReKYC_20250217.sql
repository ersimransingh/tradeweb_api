...
BEGIN
  ...
  BEGIN
   ...
   THEN CASE WHEN ISNULL(o.ColumnValue,'') = 'true' THEN 'Y' ELSE 'False' End ELSE  ISNULL(o.ColumnValue,'')
   END, NewValue = CASE WHEN ISNULL(N.ColumnName,'') = 'NomineeResidualSecurities' 
   THEN CASE WHEN ISNULL(n.ColumnValue,'') = 'true' THEN 'Y' ELSE 'False' End ELSE  ISNULL(n.ColumnValue,'')
