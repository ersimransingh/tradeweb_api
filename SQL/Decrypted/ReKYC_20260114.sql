 ...
 SET @o_vcErrorMessage = 'Process Completed'
  ...
  BEGIN  
	...
	BEGIN
      ...
      IF @Cx_AppType = '03'			   
	  BEGIN
	    SET @str20String = @str20String+'01'+'|'+'02'+'|'+'02'+'|'+'02'+'|'+'02'+'|'+'02'+'|'+'02'+'|'+'02'+'|'+'02'+'|'+'02'+'|'+LTRIM(RTRIM(@strconstitution))+'|||'+LTRIM(RTRIM(@CK_ActType))+'|'+RTRIM(LTRIM(ISNULL(@cx_Reference,'')))+'|'
 	  END
	  ELSE				   
	  BEGIN
	  ...
	  SET @str20String = @str20String+LTRIM(RTRIM(@cx_prefix))+'|'+LTRIM(RTRIM(@CK_Fname))+'|'+LTRIM(RTRIM(@CK_Middlename))+'|'+LTRIM(RTRIM(@CK_Lname))+'|'+@strEntityName+'||||||'
	  ...
	  BEGIN
	    ...
	    CAST(ma_proof AS VARCHAR(MAX)) AS DO1,
